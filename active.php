							...
							<div class="col-xl-12">
								<div class="m-portlet m-portlet--mobile ">
									...
									<div class="m-portlet__body">
										...
										<?php
											$sql = "SELECT * FROM coco_keys WHERE isactive = 'true'";
												...
												while($row = mysqli_fetch_array($result)){
													echo '
														<tr>
															...
															<td>'.$row['keytype'].'</td>
															<td>
																<a id="'.$row['keyid'].'" class="deactivate m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Delete">
